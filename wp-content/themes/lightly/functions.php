...
if ( ! function_exists( 'lightly_setup' ) ) :
	...
	function lightly_setup() {
		...
		register_nav_menus( array(
			'primary'   => __( 'Primary Menu', 'lightly' ),
			'footer'    => __( 'Footer Menu', 'lightly' ),
		) );
...
function lightly_register_sidebars() {
	register_sidebar( array(
		'id'            => 'sidebar-1',
		'name'          => __( 'Sidebar', 'lightly' ),
		'description'   => __( 'The first (primary) sidebar.', 'lightly' ),
	...
	register_sidebar( array(
		'id'            => 'footer-sidebar-1',
		'name'          => __( 'Footer Sidebar 1', 'lightly' ),
		'description'   => __( 'First footer widget area.', 'lightly' ),
	...
	register_sidebar( array(
		'id'            => 'footer-sidebar-2',
		'name'          => __( 'Footer Sidebar 2', 'lightly' ),
		'description'   => __( 'Second footer widget area', 'lightly' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widgettitle"><span>',
		'after_title'   => '</span></h4>',
	...
	register_sidebar( array(
		'id'            => 'footer-sidebar-3',
		'name'          => __( 'Footer Sidebar 3', 'lightly' ),
		'description'   => __( 'Third footer widget area', 'lightly' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widgettitle"><span>',
		'after_title'   => '</span></h4>',
	...
	register_sidebar( array(
		'id'            => 'footer-sidebar-4',
		'name'          => __( 'Footer Sidebar 4', 'lightly' ),
		'description'   => __( 'Fourth footer widget area', 'lightly' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widgettitle"><span>',
		'after_title'   => '</span></h4>',
	...
	register_sidebar( array(
		'id'            => 'header-sidebar',
		'name'          => __( 'Header Sidebar', 'lightly' ),
		'description'   => __( 'Widget area on the header, best use for advertisement.', 'lightly' ),
		'before_widget' => '<div id="%1$s" class="widget clearfix %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widgettitle"><span>',
		'after_title'   => '</span></h4>'
