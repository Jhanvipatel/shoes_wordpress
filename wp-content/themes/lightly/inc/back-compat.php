...
function lightly_upgrade_notice() {
	$message = sprintf( __( 'Lightly requires at least WordPress version 4.5. You are running version %s. Please upgrade and try again.', 'lightly' ), $GLOBALS['wp_version'] );
...
function lightly_customize() {
	wp_die( sprintf( __( 'Lightly requires at least WordPress version 4.5. You are running version %s. Please upgrade and try again.', 'lightly' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function lightly_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Lightly requires at least WordPress version 4.5. You are running version %s. Please upgrade and try again.', 'lightly' ), $GLOBALS['wp_version'] ) );
	}
}
