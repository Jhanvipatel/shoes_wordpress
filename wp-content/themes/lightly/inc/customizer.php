...
function lightly_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'theme_settings',
		array(
			'title'    => __( 'Theme Settings', 'lightly' ),
			'priority' => 20,
		)
	);
	...
	$wp_customize->add_section( 'featured_slider',
		array(
			'title'    => __( 'Featured Slider', 'lightly' ),
			'priority' => 30,
		)
	);
...
function lightly_customize_items( $settings ) {
	...
	$settings[] = array(
		'label'                => __( 'Disable Category/Tags Meta Box on Single Page', 'lightly' ),
	...
	$settings[] = array(
		'label'                => __( 'Disable Post Navigation Box on Single Page', 'lightly' ),
	...
	$settings[] = array(
		'label'                => __( 'Disable Author Box on Single Page', 'lightly' ),
	...
	$settings[] = array(
		'label'                => __( 'Disable Related Posts Box on Single Page', 'lightly' ),
	...
	$settings[] = array(
		'label'             => __( 'Exclude Categories', 'lightly' ),
		...
		'description'       => __( 'Choose which categories to exclude from recent posts on homepage', 'lightly' )
	);
	...
	$settings[] = array(
		'label'                => __( 'Activate Featured Posts Slider', 'lightly' ),
		...
		'sanitize_callback'    => 'lightly_sanitize_checkbox',
		'sanitize_js_callback' => 'lightly_sanitize_checkbox_js',
		'description'          => __( 'The Featured posts slider, check it to show on homepage', 'lightly' )
	);

	$settings[] = array(
		'label'             => __( 'Featured Posts Title', 'lightly' ),
		'id'                => 'featured_slider_title',
		'section'           => 'featured_slider',
		'default'           => __( 'Featured', 'lightly' ),
		'transport'         => 'postMessage',
		'control'           => 'text',
		'sanitize_callback' => 'sanitize_text_field',
		'description'       => __( 'The featured posts slider title', 'lightly' )
	);

	$settings[] = array(
		'label'             => __( 'Post Categories.', 'lightly' ),
		...
		'sanitize_callback' => 'lightly_sanitize_choice',
		'choices'           => lightly_choice_taxonomy(),
		'description'       => __( 'Choose which categories to show on the slider', 'lightly' )
	);

	$settings[] = array(
		'label'             => __( 'Show Maximum Posts Number', 'lightly' ),
		...
		'description'       => __( 'Select the number of posts to show on the slider.', 'lightly' )
	);

	$settings[] = array(
		'label'                => __( 'Enable Auto Slide', 'lightly' ),
		...
		'sanitize_callback'    => 'lightly_sanitize_checkbox',
		'sanitize_js_callback' => 'lightly_sanitize_checkbox_js',
		'description'          => __( 'Check if you want the slider do auto sliding.', 'lightly' )
	);

	$settings[] = array(
		'label'             => __( 'Auto slide timer', 'lightly' ),
		...
		'description'       => __( 'Select the auto slide time, in second(s).', 'lightly' )
	);

	$settings[] = array(
		'label'                => __( 'Hide On Page 2 & Next', 'lightly' ),
		...
		'sanitize_callback'    => 'lightly_sanitize_checkbox',
		'sanitize_js_callback' => 'lightly_sanitize_checkbox_js',
		'description'          => __( 'Hide the featured slider to show headline for page 2 and next.', 'lightly' )
	);
