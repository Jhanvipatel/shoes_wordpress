...
class Lightly_Widget_Tabs extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'lightly_tabs', __( 'Lightly - Tabs', 'lightly' ), array(
			'classname'   => 'tabs-widget',
			'description' => __( 'Displays recent posts, comments, categories etc in multiple tabs.', 'lightly' )
		) );
	}
	...
	function widget( $args, $instance ) {
		...
		$tab[1] = apply_filters( 'widget_title', __( 'Recent Posts', 'lightly' ) );
		$tab[2] = apply_filters( 'widget_title', __( 'Recent Response', 'lightly' ) );
		$tab[3] = apply_filters( 'widget_title', __( 'Tags', 'lightly' ) );
		$tab[4] = apply_filters( 'widget_title', __( 'Popular Posts', 'lightly' ) );
		$tab[5] = apply_filters( 'widget_title', __( 'Browse Categories', 'lightly' ) );
		$tab[6] = apply_filters( 'widget_title', __( 'Browse Archives', 'lightly' ) );
		$tab[7] = apply_filters( 'widget_title', __( 'Browse Pages', 'lightly' ) );
	...
	function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_one_title' ) ); ?>"><?php _e( 'Tab One Title:', 'lightly' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_one' ) ); ?>"><?php _e( 'Tab One Content:', 'lightly' ); ?></label><br/>
			<select id="<?php echo esc_attr( $this->get_field_id( 'widget_one' ) ); ?>"
				...
				<option
					value="1" <?php selected( 1, $widget_one ); ?>><?php _e( 'Recent Posts', 'lightly' ); ?></option>
				<option
					value="2" <?php selected( 2, $widget_one ); ?>><?php _e( 'Recent Comments', 'lightly' ); ?></option>
				<option
					value="3" <?php selected( 3, $widget_one ); ?>><?php _e( 'Tag Clouds', 'lightly' ); ?></option>
				<option
					value="4" <?php selected( 4, $widget_one ); ?>><?php _e( 'Popular Posts', 'lightly' ); ?></option>
				<option
					value="5" <?php selected( 5, $widget_one ); ?>><?php _e( 'Categories', 'lightly' ); ?></option>
				<option
					value="6" <?php selected( 6, $widget_one ); ?>><?php _e( 'Archives', 'lightly' ); ?></option>
				<option
					value="7" <?php selected( 7, $widget_one ); ?>><?php _e( 'Pages', 'lightly' ); ?></option>
			</select>
		</p>
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_two_title' ) ); ?>"><?php _e( 'Tab Two Title:', 'lightly' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_two' ) ); ?>"><?php _e( 'Tab Two Content:', 'lightly' ); ?></label><br/>
			<select id="<?php echo esc_attr( $this->get_field_id( 'widget_two' ) ); ?>"
				...
				<option
					value="1" <?php selected( 1, $widget_two ); ?>><?php _e( 'Recent Posts', 'lightly' ); ?></option>
				<option
					value="2" <?php selected( 2, $widget_two ); ?>><?php _e( 'Recent Comments', 'lightly' ); ?></option>
				<option
					value="3" <?php selected( 3, $widget_two ); ?>><?php _e( 'Tag Clouds', 'lightly' ); ?></option>
				<option
					value="4" <?php selected( 4, $widget_two ); ?>><?php _e( 'Popular Posts', 'lightly' ); ?></option>
				<option
					value="5" <?php selected( 5, $widget_two ); ?>><?php _e( 'Categories', 'lightly' ); ?></option>
				<option
					value="6" <?php selected( 6, $widget_two ); ?>><?php _e( 'Archives', 'lightly' ); ?></option>
				<option
					value="7" <?php selected( 7, $widget_two ); ?>><?php _e( 'Pages', 'lightly' ); ?></option>
			</select>
		</p>
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_three_title' ) ); ?>"><?php _e( 'Tab Three Title:', 'lightly' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_three' ) ); ?>"><?php _e( 'Tab Three Content:', 'lightly' ); ?></label><br/>
			<select id="<?php echo esc_attr( $this->get_field_id( 'widget_three' ) ); ?>"
				...
				<option
					value="1" <?php selected( 1, $widget_three ); ?>><?php _e( 'Recent Posts', 'lightly' ); ?></option>
				<option
					value="2" <?php selected( 2, $widget_three ); ?>><?php _e( 'Recent Comments', 'lightly' ); ?></option>
				<option
					value="3" <?php selected( 3, $widget_three ); ?>><?php _e( 'Tag Clouds', 'lightly' ); ?></option>
				<option
					value="4" <?php selected( 4, $widget_three ); ?>><?php _e( 'Popular Posts', 'lightly' ); ?></option>
				<option
					value="5" <?php selected( 5, $widget_three ); ?>><?php _e( 'Categories', 'lightly' ); ?></option>
				<option
					value="6" <?php selected( 6, $widget_three ); ?>><?php _e( 'Archives', 'lightly' ); ?></option>
				<option
					value="7" <?php selected( 7, $widget_three ); ?>><?php _e( 'Pages', 'lightly' ); ?></option>
			</select>
		</p>
		<?php
	}
