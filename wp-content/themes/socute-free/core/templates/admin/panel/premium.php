<?php 
$landing = 'http://yithemes.com/themes/wordpress/socute-multi-purpose-e-commerce-theme/?utm_source=yith-panel&utm_medium=wpadmin&utm_content=tab-premium-socute&utm_campaign=yith-admin';
$live = 'http://preview.yithemes.com/socute/';
...
$name = 'Socute Ecommerce Theme';
$price = '65';

if ( false === ( $price = get_transient( 'yit_theme_price_' . get_template() ) ) ) {
    $requrl = 'yithemes.com/?wc-api=yit_theme_price&theme=socute';
