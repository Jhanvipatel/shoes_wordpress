...
<div id="comments" class="comments-container">
	...
	comment_form(
		array('comment_notes_after' => '',
				...
				'comment_field' =>  '<div class="comment_auth_message"><p class="comment-form-comment"><textarea id="comment" name="comment" placeholder="'.__('Message', 'shopera').'" cols="45" rows="8" aria-required="true">' . '</textarea></p></div>')
		);
	?>
