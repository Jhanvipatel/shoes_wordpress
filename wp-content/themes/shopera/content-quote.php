...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		<span class="post-format post-format-quote">
			<a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'quote' ) ); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
		</span>
		<?php
