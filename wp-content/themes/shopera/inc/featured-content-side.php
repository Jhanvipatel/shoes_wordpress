...
class Featured_Content_Side {
	 ...
	 * passed in the call to add_theme_support( 'featured-side-content' ).
	 *
	 ...
	 * add_theme_support( 'featured-side-content' ); during after_setup_theme.
	 *
	...
	public static function init() {
		$theme_support = get_theme_support( 'featured-side-content' );
	...
	public static function get_featured_post_ids() {
		...
		$post_tag_slug = ot_get_option( 'slider_side_tag' );
		$term = get_term_by( 'name', $post_tag_slug, 'post_tag' );
		if ( $term ) {
			$tag = $term->term_id;
		} else {
	...
	public static function delete_post_tag( $tag_id ) {
		...
		update_option( 'featured-side-content', $settings );
	}
	...
	public static function register_setting() {
		register_setting( 'featured-side-content', 'featured-side-content', array( __CLASS__, 'validate_settings' ) );
	}
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'featured_content_side', array(
			...
			'priority'       => 130,
			'theme_supports' => 'featured-side-content',
		) );
	...
	public static function get_setting( $key = 'all' ) {
		$saved = (array) get_option( 'featured-side-content' );
