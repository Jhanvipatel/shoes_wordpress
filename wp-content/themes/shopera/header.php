...
if ( is_archive() || is_search() || is_404() ) {
	...
	$layout_type = ot_get_option('shopera_layout_style') ? ot_get_option('shopera_layout_style') : 'full';
}
...
<div id="page" class="hfeed site">
	...
	<?php
		$slider_state = ot_get_option('slider_main_state');
		if ( is_front_page() && shopera_has_featured_posts() && $slider_state == 'on' ) {
